...
// Sample data for communities, users, and roles (you should use a database in production)
const communities = {
  '7039920812358371327': {
    name: 'Community 1',
    admin: '7039921766419924991',
  },
};

// In-memory database for storing user data (replace with your database)
const users = [
];

const roles = {
  '7039873122358527999': 'Community Admin',
};
